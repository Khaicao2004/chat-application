...
const ChatLayout = ({ children }) => {
    ...
    useEffect(() => {
        Echo.join("online")
            .here((users) => {
                const ounlineUsersObj = Object.fromEntries(
                    users.map((user) => [user.id, user])
                );
                setOnlineUsers((prevOnlineUsers) => {
                    return { ...prevOnlineUsers, ...ounlineUsersObj };
                });
            })
            .joining((user) => {
                setOnlineUsers((prevOnlineUsers) => {
        ...
        <>
            <div className="flex-1 w-full flex overflow-hidden">
                ...
                >
                    ...
                    <div className="p-3">
                        <TextInput onKeyUp={onSearch} placeholder="Filter users and groups" className="w-full"></TextInput>
                    </div>
